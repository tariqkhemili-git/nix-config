        ...
        settings = {
          ...
          animations = {
            ...
            animation = [
              ...
              "layers, 1, 2.5, overshot, fade"
              "layersIn, 1, 2, overshot, fade"
              "layersOut, 1, 1.5, snappy, fade"
              "fade, 1, 2, snappy"
  ...
  programs = {
    ...
    fish = {
      ...
      shellAbbrs = {
        ...
        swis = ''sudo echo "Sudo access granted" && nh os boot ~/.nix && shutdown now'';
        swir = ''sudo echo "Sudo access granted" && nh os boot ~/.nix && reboot'';
        swifw = ''sudo echo "Sudo access granted" && nh os boot ~/.nix && systemctl reboot --firmware-setup'';
        upd = ''sudo echo "Sudo access granted" && nh os switch -u ~/.nix'';
        upds = ''sudo echo "Sudo access granted" && nh os boot -u ~/.nix && shutdown now'';
        updr = ''sudo echo "Sudo access granted" && nh os boot -u ~/.nix && reboot'';
        updfw = ''sudo echo "Sudo access granted" && nh os boot -u ~/.nix && systemctl reboot --firmware-setup'';
        gitswi = ''z ~/.nix && sudo echo "Sudo access granted" && nh os switch ~/.nix && git add . && git commit -m "" && git push -u origin main'';
        gitswis = ''z ~/.nix && sudo echo "Sudo access granted" && nh os boot ~/.nix && git add . && git commit -m "" && git push -u origin main && shutdown now'';
        gitswir = ''z ~/.nix && sudo echo "Sudo access granted" && nh os boot ~/.nix && git add . && git commit -m "" && git push -u origin main && reboot'';
        gitswifw = ''z ~/.nix && sudo echo "Sudo access granted" && nh os boot ~/.nix && git add . && git commit -m "" && git push -u origin main && systemctl reboot --firmware-setup'';
        gitupd = ''z ~/.nix && sudo echo "Sudo access granted" && nh os switch -u ~/.nix && git add . && git commit -m "" && git push -u origin main'';
        gitupds = ''z ~/.nix && sudo echo "Sudo access granted" && nh os boot -u ~/.nix && git add . && git commit -m "" && git push -u origin main && shutdown now'';
        gitupdr = ''z ~/.nix && sudo echo "Sudo access granted" && nh os boot -u ~/.nix && git add . && git commit -m "" && git push -u origin main && reboot'';
        gitupdfw = ''z ~/.nix && sudo echo "Sudo access granted" && nh os boot -u ~/.nix && git add . && git commit -m "" && git push -u origin main && systemctl reboot --firmware-setup'';
